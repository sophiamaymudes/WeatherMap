...
data class WeatherResult(val coord: Coord?, val weather: List<Weather1757083826>?, val base: String?,
...
data class Weather1757083826(val id: Number?, val main: String?, val description: String?, val icon: String?)
